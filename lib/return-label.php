<?php
  ...
  $result = $conn->query("SELECT * FROM `products` WHERE id_cate = 4");
?>

<div class="row" style="margin-top: 10px; margin-left: 5px; margin-right: 5px;">
  <div class="col-md-9">
    <div style="margin-bottom: 10px; text-align: center;">
  <img src="images/return.jpg" width="100%">  
</div>

<div class="panel panel-info">
      <div class="panel-heading" style="font-weight: bold;">HÀNG ĐỔI TRẢ - TIẾT KIỆM CHI PHÍ</div>
