        				...
        				?>
		                                    <tr class="odd gradeX">
		                                        ...
		                                        <td style="text-align: center;">
		                                        	<button type="button" class="btn btn-success" onclick="window.location.href='?thread=view-detail-users&id-users=<?php echo $row['id']; ?>'"><span class="glyphicon glyphicon-fullscreen"></span></button>
				                                        	<span> | </span>
		                                        	<button type="button" class="btn btn-warning" onclick="if (confirm('Khi chỉnh sửa thông tin bạn phải nhập lại mật khẩu!')) window.location.href='?thread=edit-users&id-users=<?php echo $row['id']; ?>'"><span class="glyphicon glyphicon-pencil"></span></button>
				                                        	<span> | </span>
				                                    <button type="button" class="btn btn-danger" onclick="if (confirm('Bạn có chắc chắn xoá mục này không?')) window.location.href='?thread=delete-users&id-users=<?php echo $row['id']; ?>'"><span class="glyphicon glyphicon-remove"></span></button>
		                                        </td>
		                                    </tr>
                        <?php
            					}
