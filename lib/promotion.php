<?php
  ...
  $result = $conn->query("SELECT * FROM `products` WHERE id_cate = 5");
?>

<div class="row" style="margin-top: 10px; margin-left: 5px; margin-right: 5px;">
  <div class="col-md-9">
    <div style="margin-bottom: 10px; text-align: center;">
  <img src="images/promotion.png" width="100%">  
</div>

<div class="panel panel-info">
      <div class="panel-heading" style="font-weight: bold;">SẢN PHẨM KHUYẾN MÃI</div>
