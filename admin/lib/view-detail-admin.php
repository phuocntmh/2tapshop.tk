		...
		<div class="panel panel-primary">
          ...
          <div class="form-group">
        	...
        	<div class="col-sm-offset-3 col-sm-9">
              <div class="col-sm-9">
                <button class="btn btn-info" onclick="window.location.href='?thread=admin-list'"><span class="glyphicon glyphicon-repeat"></span> Quay về</button>
                <button class="btn btn-warning" onclick="if (confirm('Khi chỉnh sửa thông tin bạn phải nhập lại mật khẩu!')) window.location.href='?thread=edit-admin&id-admin=<?php echo $id_users; ?>'"><span class="glyphicon glyphicon-pencil"></span> Chỉnh sửa</button>
              </div>
            </div>
			</div>
		</div>
