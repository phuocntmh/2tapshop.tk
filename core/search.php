<?php
  ...
  $result = $conn->query("SELECT * FROM `products` WHERE name LIKE '%{$keyword}' OR name LIKE '%{$keyword}%' OR name LIKE '{$keyword}%'");
?>

<div class="row" style="margin-top: 10px; margin-left: 5px; margin-right: 5px;">
  <div class="col-md-9">
    <div style="margin-bottom: 10px; text-align: center;">
    <img src="images/accessories.png" width="100%">  
  </div>

  <div class="panel panel-info">
        <div class="panel-heading"><b>KẾT QUẢ TÌM KIẾM CHO TỪ KHOÁ:</b> <?php echo $keyword; ?></div>
        <div class="panel-body">
          ...
          <?php
            ...
            {
              echo "Không tìm thấy sản phẩm mà bạn yêu cầu. Vui lòng thử lại với từ khoá khác!";
            }
          ?>
        </div>
    </div>
